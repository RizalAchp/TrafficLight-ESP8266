...
#define SECOND_MS(SEC)  1000UL * SEC
#define INTERVAL_YELLOW SECOND_MS(2)  // SECOND_MS * 2 = 2 detik
#define INTERVAL_RED    SECOND_MS(30)
#define INTERVAL_GREEN  SECOND_MS(30)
#define INTERVAL_ISFIVE SECOND_MS(10)
#define CAPTURE_TIME    SECOND_MS(25)
